...
Firstly, we motivated the adoption of a serverless architecture and the \textit{Function-as-a-Service} model.
...
%of these tools 
%and 
the feasibility of the \textit{Serverless Edge Platform} in satisfying different application requirements in heterogeneous types of deployments.
