...
Addressing the needs of different applications scenarios and the intrinsic characteristics of edge infrastructures, in this paper we propose a serverless platform for edge computing. 
...
%of these tools 
%and 
the feasibility of the \textit{Serverless Edge Platform} in tackling different application scenarios in heterogeneous types of edge infrastructures.
