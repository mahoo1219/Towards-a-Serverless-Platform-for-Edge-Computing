...
%TODO
The prototype was evaluated in terms of its resource utilization footprint, latency overhead, throughput, and scalability in a resource-constrained fog deployment. Results demonstrated the feasibility of the proposed \textit{Serverless Edge Platform}.% in tackling the needs of distinct application scenarios.
