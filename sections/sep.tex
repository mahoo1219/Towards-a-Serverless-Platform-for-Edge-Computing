...
Informed of this decision, the SEP allocates new instances upon demand. As the volume of requests increases and the placement limited is achieved, a \textit{Load Balancer} diverges part of the requests to the cloud-based FaaS, taking into account the average response time of each function and its requirement for latency.
